...
const makingGetCall = (item, file) => new Promise((resolve, reject) => { //a la funcion makingGetCall, le paso un array de URLS
    axios.get(item.href) //con anxios.get hago la llamada GET a la URL . Esto guarda un array de promesas
